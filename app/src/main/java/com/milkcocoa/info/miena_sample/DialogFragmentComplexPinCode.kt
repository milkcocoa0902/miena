...
class DialogFragmentComplexPinCode(private val listener: DialogFragmentLongPinCodeListener): DialogFragment() {
    interface DialogFragmentLongPinCodeListener{
        fun onCancel()
        fun onComplete(pin: String)
    }
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return layoutInflater.inflate(R.layout.dialog_fragment_input_long_pincode, null, false)
            .apply {
