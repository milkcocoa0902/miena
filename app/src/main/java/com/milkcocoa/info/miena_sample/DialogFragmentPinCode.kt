...
class DialogFragmentPinCode(private val listener: DialogFragmentPinCodeListener): DialogFragment() {
    interface DialogFragmentPinCodeListener{
        fun onCancel()
        fun onComplete(pin: String)
    }
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return layoutInflater.inflate(R.layout.dialog_fragment_input_pincode, null, false)
            .apply {
